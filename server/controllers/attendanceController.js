...
export const clockInOut = async (req, res)=>{
    try{
        ...
        if(employee.isDeleted) return res.status(403).json({error: "Your account is deactivated. Your clouck in.out. ", });
        ...
        if(!existing){
            ...
            //Compute working hours and day types
