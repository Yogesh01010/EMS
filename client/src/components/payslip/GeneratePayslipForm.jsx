        ...
        <div className='fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4'>
            <div className='card max-w-lg w-full p-6 animate-slide-up'>
                <div className='flex justify-between items-center mb-6'>
                    <h3 className='text-lg font-bold text-slate-900'>Generate Monthaly Payslip</h3>
                ...
                <form onSubmit={handleSubmit} className='space-y-4'>
                    ...
                    <div>
                        ...
                        <input type="number" name='basicSalary' required placeholder='1000....' />
                    </div>
                    ...
                    <div className='flex justify-end gap-3 pt-2'>
                        ...
                        <button disabled={loading} type='button' className='btn-primary flex items-center'>
