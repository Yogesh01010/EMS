            ...
            <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white">
                <div className="w-full max-w-md animate-fade-in">
                    ...
                    <form className="space-y-5" onSubmit={HandleSubmit}>
                        <div>
                            <lable className="block text-sm font-medium text-slate-700 mb-2">Email address</lable>
                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="abc123@gmail.com" />
                        </div>
                        <div>
                            <lable className="block text-sm font-medium text-slate-700 mb-2">Password</lable>
                        ...
                        <button type="submit" disabled={loading} className="w-full py-3 bg-linear-to-r from-indigo-600 to-indigo-400 text-white rounded-md
                        text-sm font-semibold hover:from-indigo-700 hover:to-indigo-600 disabled:opacity-50 transition-all duration-200 shadow-lg shadow-indigo-500/25
