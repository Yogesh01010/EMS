...
const Sidebar = () => {
    ...
    const sidebarContent = (
        <>
            ...
            {/* Navigation List  */}
            <div className='flex-1 px-3 space-y-0.5 overflow-auto'>
                {navItems.map((item) => {
    ...
    return (
        <>
            ...
            <button onClick={() => setMobileOpen(true)} className='lg:hidden fixed top-4 left-4 z-50 p-2 bg-slate-900 text-white rounded-lg shadow-lg border-white/10'>
                <MenuIcon size={20} />
            </button>
