...
const EmployeeForm = ({ initialData, onSuccess, onCancel }) => {
    ...
    return (
        <form onSubmit={handleSubmit()} className='space-y-6 max-w-3xl animate-fade-in'>
            ...
            {/* Employment Details  */}
            <div className='card p-5 sm:p-6'>
                <h3 className='text-base font-medium text-slate-600 mb-6 pb-4 border-b border-slate-100'>Employment Details</h3>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" name='allowances' required min="0" step="0.01" defaultValue={initialData?.deductions || 0} />
                    </div>
                    {isEditMode && (
                        <div>
